"""
run_one_seed.py — Run ONE SEED only, exit after done, maximum memory cleanup
Usage: python run_one_seed.py <dropout> <seed_index>
"""
...
def main():
    if len(sys.argv) != 3:
        print("Usage: python run_one_seed.py <dropout> <seed_index 0-2>")
        print(f"  SEEDS = {SEEDS}")
        sys.exit(1)
    ...
    print("="*70)
    print(f"  Run ONE SEED: dropout={dropout}, seed={seed} (idx={seed_idx})")
    print("="*70)
